...
export default function Education() {
  ...
  return (
    <section id="education" className="page-offset">
      <div className="section-inner">
        <p className="section-label">Education &amp; Skilling</p>
        <h2 className="section-title">AI for Finance Education Programme</h2>
        <p className="section-sub">
          Modular, applied, and connected to Indian markets — from BTech students to C-suite executives.
        </p>
